...
<div class="mb-3">
    ...
    <input type="text" name="genre" class="form-control" placeholder="e.g. RPG, Shooter" value="{{ old('genre') }}">
</div>
...
<div class="mb-3">
    ...
    <input type="text" name="platform" class="form-control @error('platform') is-invalid @enderror"
        placeholder="e.g. PC, PS5" value="{{ old('platform') }}">
    @error('platform')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="number" name="playtime" class="form-control" placeholder="e.g. 42" value="{{ old('playtime') }}">
</div>

<!-- START DATE -->
<div class="mb-3">
    <label class="form-label fw-bold">Started On</label>
    <input type="date" name="started_on" class="form-control" value="{{ old('started_on') }}">
</div>

<!-- COMPLETION DATE -->
<div class="mb-3">
    <label class="form-label fw-bold">Completed On</label>
    <input type="date" name="completed_on" class="form-control" value="{{ old('completed_on') }}">
</div>
